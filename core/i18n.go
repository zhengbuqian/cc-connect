...
const (
	...
	MsgBoqCreateUsage            MsgKey = "boq_create_usage"
	MsgBoqCreateAlreadyBound     MsgKey = "boq_create_already_bound"
	MsgBoqDestroyUsage           MsgKey = "boq_destroy_usage"
	MsgBoqDestroyOtherWhileBound MsgKey = "boq_destroy_other_while_bound"
)
...
var messages = map[MsgKey]map[Language]string{
	...
	MsgBuiltinCmdBoq: {
		LangEnglish:            "Manage boq container isolation",
		LangChinese:            "管理 boq 容器隔离",
		LangTraditionalChinese: "管理 boq 容器隔離",
		LangJapanese:           "boq コンテナ分離を管理",
		LangSpanish:            "Gestionar aislamiento de contenedores boq",
	},
	MsgBuiltinCmdTTS: {
	...
	MsgBoqUsage: {
		LangEnglish:            "Usage: `/boq enter <name>` | `/boq exit` | `/boq create <name>` | `/boq destroy [name]` | `/boq list` | `/boq`",
		LangChinese:            "用法: `/boq enter <名称>` | `/boq exit` | `/boq create <名称>` | `/boq destroy [名称]` | `/boq list` | `/boq`",
		LangTraditionalChinese: "用法: `/boq enter <名稱>` | `/boq exit` | `/boq create <名稱>` | `/boq destroy [名稱]` | `/boq list` | `/boq`",
		LangJapanese:           "使い方: `/boq enter <名前>` | `/boq exit` | `/boq create <名前>` | `/boq destroy [名前]` | `/boq list` | `/boq`",
		LangSpanish:            "Uso: `/boq enter <nombre>` | `/boq exit` | `/boq create <nombre>` | `/boq destroy [nombre]` | `/boq list` | `/boq`",
	},
	MsgBoqEnterUsage: {
	...
	MsgBoqListHint: {
		LangEnglish:            "Use `/boq enter <name|number> [workspace]` to enter.",
		LangChinese:            "使用 `/boq enter <名称|序号> [工作区]` 进入。",
		LangTraditionalChinese: "使用 `/boq enter <名稱|序號> [工作區]` 進入。",
		LangJapanese:           "`/boq enter <名前|番号> [ワークスペース]` で入れます。",
		LangSpanish:            "Use `/boq enter <nombre|número> [workspace]` para entrar.",
	},
	MsgBoqInvalidIndex: {
	...
	MsgBoqCreateUsage: {
		LangEnglish:            "Usage: `/boq create <name> [workspace]`\nExample: `/boq create dev` or `/boq create dev milvus`",
		LangChinese:            "用法: `/boq create <名称> [工作区]`\n示例: `/boq create dev` 或 `/boq create dev milvus`",
		LangTraditionalChinese: "用法: `/boq create <名稱> [工作區]`\n範例: `/boq create dev` 或 `/boq create dev milvus`",
		LangJapanese:           "使い方: `/boq create <名前> [ワークスペース]`\n例: `/boq create dev` または `/boq create dev milvus`",
		LangSpanish:            "Uso: `/boq create <nombre> [workspace]`\nEjemplo: `/boq create dev` o `/boq create dev milvus`",
	},
	MsgBoqCreateAlreadyBound: {
		LangEnglish:            "❌ Already inside boq **%s**. Use `/boq exit` first, then create a new one.",
		LangChinese:            "❌ 当前已在 boq **%s** 内。请先 `/boq exit`，再创建新的。",
		LangTraditionalChinese: "❌ 當前已在 boq **%s** 內。請先 `/boq exit`，再建立新的。",
		LangJapanese:           "❌ すでに boq **%s** 内にいます。先に `/boq exit` してから作成してください。",
		LangSpanish:            "❌ Ya estás dentro de boq **%s**. Usa `/boq exit` primero, luego crea uno nuevo.",
	},
	MsgBoqDestroyUsage: {
		LangEnglish:            "Usage: `/boq destroy <name>`\nExample: `/boq destroy dev`",
		LangChinese:            "用法: `/boq destroy <名称>`\n示例: `/boq destroy dev`",
		LangTraditionalChinese: "用法: `/boq destroy <名稱>`\n範例: `/boq destroy dev`",
		LangJapanese:           "使い方: `/boq destroy <名前>`\n例: `/boq destroy dev`",
		LangSpanish:            "Uso: `/boq destroy <nombre>`\nEjemplo: `/boq destroy dev`",
	},
	MsgBoqDestroyOtherWhileBound: {
		LangEnglish:            "❌ Cannot destroy **%s** while inside boq **%s**. Use `/boq destroy` (without name) to exit and destroy the current boq, or `/boq exit` first.",
		LangChinese:            "❌ 不能销毁 **%s**，当前在 boq **%s** 内。使用 `/boq destroy`（不带名称）退出并销毁当前 boq，或先 `/boq exit`。",
		LangTraditionalChinese: "❌ 不能銷毀 **%s**，當前在 boq **%s** 內。使用 `/boq destroy`（不帶名稱）退出並銷毀當前 boq，或先 `/boq exit`。",
		LangJapanese:           "❌ **%s** を破棄できません。現在 boq **%s** 内にいます。`/boq destroy`（名前なし）で現在の boq を終了・破棄するか、先に `/boq exit` してください。",
		LangSpanish:            "❌ No se puede destruir **%s** mientras estás dentro de boq **%s**. Usa `/boq destroy` (sin nombre) para salir y destruir el boq actual, o `/boq exit` primero.",
	},
}
